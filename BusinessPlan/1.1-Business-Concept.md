...
2. **Succeed where others have failed (in Australia, Brazil, Haiti etc):**
    ...
    > - _flow of value from ‘planters’? vs projected yield = Tree Coin Exchange Rate_
    
    > - _visiting ‘planters’ will have restricted access, remote /online ‘planters’ will have unlimited access_
