...
1. Item **I. Grow Japanese Trees in the Caribbean:  Then sell/ export, re-plant & repeat**

1. Item **II.	Learning from Others: investments, successes & failures**

1. Item **III.	Trial-Run(s): self-financed,  passionate experts, existing (solar-energy) plantation** 

1. Item **IV.	Scalable: plantation & organisation**
